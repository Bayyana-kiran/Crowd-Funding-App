...
function NGORegistration() {
  ...
  const handleFounderChange = (index, e) => {
    ...
    if (type === 'file' && files[0]) {
      ...
      reader.onload = (event) => {
        localStorage.setItem(`founder_${index}_idProof`, event.target.result);
      };
  ...
  const handleFileUpload = (e, type) => {
    ...
    if (file) {
        ...
        reader.onload = (event) => {
            ...
            localStorage.setItem(type, fileData);

            // Update formData with the file data
            setFormData((prev) => ({
                ...prev,
                [type]: fileData, // Store the file data (Base64)
            }));
        };
        reader.readAsDataURL(file);
    }
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <h1 className="text-4xl font-bold text-gray-900 mb-2">NGO Registration Portal</h1>
          <p className="text-lg text-gray-600">Register your organization and make a difference</p>
        </div>
        ...
        {success && (
          <div className="mb-6 p-4 bg-green-50 rounded-lg flex items-center">
            ...
            <p className="text-green-700">NGO registered successfully!</p>
          </div>
        )}
        ...
        <form onSubmit={handleSubmit} className="bg-white rounded-xl shadow-xl overflow-hidden">
          ...
          <div className="p-6 bg-gradient-to-r from-blue-600 to-indigo-600 flex items-center justify-between">
            ...
            <div className="flex items-center">
              <div className={`h-3 w-3 rounded-full mr-2 ${walletConnected ? 'bg-green-400' : 'bg-red-400'}`}></div>
              <span className="text-white">{walletConnected ? 'Connected' : 'Not Connected'}</span>
            </div>
          </div>
          ...
          <div className="p-8 space-y-8">
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex items-center justify-center w-full">
                    <label className="w-full flex flex-col items-center px-4 py-6 bg-white text-blue rounded-lg shadow-lg tracking-wide uppercase border border-blue cursor-pointer hover:bg-blue-50">
                      ...
                      <input
                        type="file"
                        onChange={(e) => handleFileUpload(e, "panNGO")}
                        required
                      />
                    </label>
                  </div>
                ...
                <div className="space-y-2">
                  <label className="block text-sm font-medium text-gray-700">Annual Report</label>
                  <div className="flex items-center justify-center w-full">
                    <label className="w-full flex flex-col items-center px-4 py-6 bg-white text-blue rounded-lg shadow-lg tracking-wide uppercase border border-blue cursor-pointer hover:bg-blue-50">
                      <Upload className="w-8 h-8 text-blue-600" />
                      <span className="mt-2 text-base leading-normal">Select file</span>
                      <input
                        type="file"
                        onChange={(e) => handleFileUpload(e, "annualReport")}
                        required
                      />
                    </label>
                  </div>
                ...
                <div className="space-y-2">
                  <label className="block text-sm font-medium text-gray-700">Legal & Financial Documents</label>
                  <div className="flex items-center justify-center w-full">
                    <label className="w-full flex flex-col items-center px-4 py-6 bg-white text-blue rounded-lg shadow-lg tracking-wide uppercase border border-blue cursor-pointer hover:bg-blue-50">
                      <Upload className="w-8 h-8 text-blue-600" />
                      <span className="mt-2 text-base leading-normal">Select file</span>
                      <input
                        type="file"
                        className="hidden"
                        onChange={(e) => handleFileUpload(e, "legalFinanceDocs")}
                        required
                      />
                    </label>
                  </div>
